package com.bank.bian.employeecertification.model;
...
/**
 * The BIAN control record for this service domain: "Certification Record Administrative Plan".
 *
 ...
 * to its asset type (Certification Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Certification Record Administrative Plan";
